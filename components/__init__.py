...
from . database import select_courses_by_date, select_weather_by_date,\
    ...
    select_current_movies, delete_movies_in_database, update_movies_in_database, delete_weather_in_database,\
    update_weather_in_database, delete_courses_in_database, update_courses_in_database,\
